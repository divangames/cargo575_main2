...
const packageTypes = [
  {
    title: "Короб и внутренняя защита",
    text: "Для штучных товаров: укладка рядами, разделители и фиксация внутри короба.",
  },
  {
    title: "Влагостойкий мешок",
    text: "Для текстиля и мягких грузов: плотная внешняя оболочка и усиление лентой.",
  },
  {
    title: "Паллетирование",
    text: "Для тяжёлых и сборных партий: стретч-плёнка, углы, ленты и жёсткое основание.",
  },
  {
    title: "Обрешётка или деревянный короб",
